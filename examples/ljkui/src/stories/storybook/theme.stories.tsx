...
import { Button, Card, Switch, Textarea, Theme, Typography } from "ljkui";
		...
		<Theme {...args}>
			<div style={{ padding: "30px 80px" }}>
				<div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
					<Typography.Text>
						Wrap a component tree in the <Typography.Code>Theme</Typography.Code> component to
						provide or modify configuration for all children.
					</Typography.Text>
