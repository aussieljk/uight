...
const meta = {
	title: "Typography/Typography.Em",
	component: Typography.Em,
	args: {
		children: "Typography.Em",
	},
	parameters: {
	...
	render: (args) => (
		<Typography.Text>
			We <Typography.Em {...args}>had</Typography.Em> to do something about it.
		</Typography.Text>
	),
} satisfies Meta<typeof Typography.Em>;
