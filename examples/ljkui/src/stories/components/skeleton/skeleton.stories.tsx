...
export const TextHighContrast: Story = {
	name: "Typography.Text high contrast",
	args: {
		size: skeletonTextPropDefs.size.default,
		color: skeletonTextPropDefs.color.default,
	},
...
const SYNC_DEMO_VARIANTS: Array<{
	...
	},
	{
		...
		render: (args) => (
			<Skeleton.Rect
				{...args}
				style={{ width: "100%", height: 80, maxWidth: 420, borderRadius: "var(--radius-2)" }}
			/>
		),
	},
	{
	...
	},
	{
		...
		render: (args) => (
			<div style={{ display: "flex", gap: "var(--space-2)" }}>
				<Skeleton.Rect
					{...args}
					style={{ width: 72, height: 72, borderRadius: "var(--radius-2)" }}
				/>
				<Skeleton.Rect
					{...args}
					style={{ width: 72, height: 72, borderRadius: "var(--radius-2)" }}
	...
	},
	{
		...
		render: (args) => (
			<div style={{ display: "flex", flexWrap: "wrap", gap: "var(--space-2)" }}>
				<Skeleton.Rect
					{...args}
					style={{ width: 56, height: 24, borderRadius: "var(--radius-5)" }}
				/>
				<Skeleton.Rect
					{...args}
					style={{ width: 72, height: 24, borderRadius: "var(--radius-5)" }}
				/>
				<Skeleton.Rect
					{...args}
					style={{ width: 48, height: 24, borderRadius: "var(--radius-5)" }}
				/>
				<Skeleton.Rect
					{...args}
					style={{ width: 64, height: 24, borderRadius: "var(--radius-5)" }}
				/>
			</div>
		),
	},
		...
		return (
			...
			>
				<p style={{ margin: 0, fontSize: "var(--font-size-2)", color: "var(--gray-11)" }}>
					All skeletons pulse in sync. Click &quot;Add row&quot; to see more layouts—new ones
					join the same phase.
				</p>
