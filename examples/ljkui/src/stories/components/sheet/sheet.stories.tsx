				...
				<Sheet.Body>
					...
					>
						<Typography.Text render={<p />} size="2" style={{ marginBottom: "var(--space-4)" }}>
							Make changes to your profile. Make changes to your profile. Make changes to your
							profile. Make changes to your profile. Make changes to your profile. Make changes
							to your profile. Make changes to your profile. Make changes to your profile. Make
							changes to your profile. Make changes to your profile. Make changes to your
							profile. Make changes to your profile. Make changes to your profile. Make changes
							to your profile. Make changes to your profile. Make changes to your profile. Make
							changes to your profile. Make changes to your profile. Make changes to your
							profile. Make changes to your profile. Make changes to your profile. Make changes
		...
		return (
			...
			>
				<Typography.Text>
					...
					focus when the sheet opens. Note: requires{" "}
					<Typography.Code>autoFocus=&#123;true&#125;</Typography.Code> on the Root.
				</Typography.Text>
				...
				<Sheet.Root autoFocus>
					...
					<Sheet.Content {...args} initialFocus={descriptionInputRef}>
						<Sheet.Header>
							...
							<Sheet.Description>
								Focus is automatically set to the Name input when the sheet opens.
							</Sheet.Description>
						</Sheet.Header>
						<Sheet.Body>
							<div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
		...
		return (
			...
			>
				<Typography.Text>
					...
					the sheet closes. Note: requires{" "}
					<Typography.Code>autoFocus=&#123;true&#125;</Typography.Code> on the Root.
				</Typography.Text>
					...
					<Sheet.Root autoFocus>
						...
						<Sheet.Content {...args} finalFocus={buttonRef}>
							<Sheet.Header>
								...
								<Sheet.Description>
									When this sheet closes, focus will return to the "Focus Here" button instead of
									the trigger.
								</Sheet.Description>
							</Sheet.Header>
							<Sheet.Body>
		...
		return (
			...
			>
				<Typography.Text style={{ maxWidth: 500, textAlign: "center" }}>
					Use <Typography.Code>finalFocus=&#123;false&#125;</Typography.Code> to prevent focus
					from returning to the trigger when the sheet closes. This is useful when you want to
					avoid scrolling back to the trigger element.
				</Typography.Text>
				...
				<Sheet.Root autoFocus>
					...
					<Sheet.Content {...args} finalFocus={false}>
						<Sheet.Header>
							...
							<Sheet.Description>
								When this sheet closes, focus will not return to the trigger button. The page will
								stay where it is.
							</Sheet.Description>
						</Sheet.Header>
						<Sheet.Body>
		...
		return (
			...
			>
				<Typography.Text>
					...
					<Typography.Code>onOpenChange</Typography.Code> for fully controlled mode with form
					state.
				</Typography.Text>
					...
					{logs.length === 0 ? (
						...
						logs.map((log, i) => (
							<div
								key={i}
								style={{
									color: log.includes("AnimationEnd") ? "var(--accent-11)" : "var(--gray-11)",
								}}
							>
								{log}
							</div>
		...
		return (
			...
			>
				<Typography.Text style={{ maxWidth: 500, textAlign: "center" }}>
					...
					inside a <Typography.Code>Sheet</Typography.Code> to confirm discarding unsaved
					changes. Uses <Typography.Code>dismissible=&#123;false&#125;</Typography.Code> to
					prevent swipe/overlay close. Type something in the textarea, then try to cancel.
				</Typography.Text>
		...
		return (
			...
			>
				<Typography.Text style={{ maxWidth: 500, textAlign: "center" }}>
					...
					<Typography.Code>open</Typography.Code> and{" "}
				...
				<DropdownMenu.Root>
					...
					<DropdownMenu.Content>
						...
						<DropdownMenu.Item onClick={() => setEditSheetOpen(true)}>
							Edit Settings...
						</DropdownMenu.Item>
		...
		return (
			...
			>
				<Typography.Text render={<div />} style={{ maxWidth: 540, textAlign: "center" }}>
					...
					<Typography.Code>closeOnClick=&#123;false&#125;</Typography.Code> to prevent the menu
					from closing before the sheet opens.
				</Typography.Text>
