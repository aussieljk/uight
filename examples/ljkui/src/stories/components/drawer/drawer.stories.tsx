		...
		<Drawer.Root>
			...
			<Drawer.Content style={{ maxWidth: 540 }} {...args}>
				...
				<Drawer.Body>
					...
					<Inset
						side="x"
						style={{ marginTop: "var(--space-5)", marginBottom: "var(--space-5)" }}
					>
...
export const DetachedTriggers: Story = {
	...
	render: (args) => (
		...
		>
			<Typography.Text>
				Use <Typography.Code>Drawer.createHandle()</Typography.Code> to control a drawer from
				a trigger located outside the <Typography.Code>Drawer.Root</Typography.Code>.
			</Typography.Text>
				...
				<Drawer.Content {...args}>
					...
					<Drawer.Body>
						<Typography.Text render={<p />} size="2">
							This drawer is controlled by a trigger outside of its Root component. This is
							useful when you need to open a drawer from a completely different part of your app.
						</Typography.Text>
						<div
							style={{
								display: "flex",
		...
		return (
			...
			>
				<Typography.Text>
					...
					<Typography.Code>payload</Typography.Code>. The payload type is inferred from the
					handle.
				</Typography.Text>
				...
				<div style={{ display: "flex", gap: "var(--space-2)" }}>
					<Drawer.Trigger
						handle={handle}
						payload={{ userId: "1", userName: "Alice", mode: "view" }}
					>
						<Button variant="surface">View Alice</Button>
					</Drawer.Trigger>
					<Drawer.Trigger
						handle={handle}
						payload={{ userId: "2", userName: "Bob", mode: "edit" }}
					>
						<Button variant="soft">Edit Bob</Button>
					</Drawer.Trigger>
					<Drawer.Trigger
						handle={handle}
						payload={{ userId: "3", userName: "Carol", mode: "edit" }}
					>
		...
		return (
			...
			>
				<Typography.Text>
					...
					<Typography.Code>onOpenChange</Typography.Code> for fully controlled mode.
				</Typography.Text>
...
export const ActionsRef: Story = {
	...
	render: function Render(args) {
		...
		return (
			...
			>
				<Typography.Text>
					Use <Typography.Code>actionsRef</Typography.Code> to close the drawer
					programmatically after an async operation.
				</Typography.Text>
...
export const InitialFocus: Story = {
	...
	render: function Render(args) {
		...
		return (
			...
			>
				<Typography.Text>
					Use <Typography.Code>initialFocus</Typography.Code> to control which element receives
...
export const FinalFocus: Story = {
	...
	render: function Render(args) {
		...
		return (
			...
			>
				<Typography.Text>
					Use <Typography.Code>finalFocus</Typography.Code> to control where focus returns when
					the drawer closes.
				</Typography.Text>
				...
				<div style={{ display: "flex", gap: "var(--space-2)", alignItems: "center" }}>
					<Drawer.Root>
						...
						<Drawer.Content {...args} finalFocus={buttonRef}>
							...
							<Drawer.Body>
								<Typography.Text render={<p />} size="2">
									When this drawer closes, focus will return to the "Focus Here" button instead of
									the trigger.
								</Typography.Text>
								<div
									style={{
					...
					<Drawer.Content {...args}>
						...
						<Drawer.Body>
							<Typography.Text render={<p />} size="2">
								...
								<Typography.Code>onOpenChangeComplete</Typography.Code> fires after the slide
								animation completes.
							</Typography.Text>
							<div
								style={{
...
export const KeepMounted: Story = {
	...
	render: function Render(args) {
		...
		return (
			...
			>
				<Typography.Text>
					Use <Typography.Code>keepMounted</Typography.Code> to preserve the drawer&apos;s DOM
					when closed. The input value persists across open/close cycles.
				</Typography.Text>
					...
					<Drawer.Content {...args} keepMounted>
						...
						<Drawer.Body>
							<Typography.Text
								...
								style={{ marginBottom: "var(--space-4)" }}
							>
								Type something below, close the drawer, then reopen it. The value will persist
								because the drawer stays mounted in the DOM.
							</Typography.Text>
		...
		return (
			...
			>
				<Typography.Text style={{ maxWidth: 500, textAlign: "center" }}>
					Drawers can be nested within one another. The parent drawer scales down and moves
					left when a child drawer opens.
				</Typography.Text>
					...
					<Drawer.Content {...args}>
						...
						<Drawer.Body>
							<Typography.Text
								...
								style={{ marginBottom: "var(--space-4)" }}
							>
								This is the parent drawer. Click the button below to open a nested drawer. Notice
								how this drawer scales down and moves to the left when the child opens.
							</Typography.Text>
							...
							<div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
								...
								<label>
									...
									<Textarea
										defaultValue="A description of the project..."
										style={{ minHeight: 80 }}
									/>
								</label>
							</div>
...
export const DeeplyNestedDrawers: Story = {
	...
	render: function Render(args) {
		...
		return (
			...
			>
				<Typography.Text style={{ maxWidth: 500, textAlign: "center" }}>
					Drawers can be nested multiple levels deep. Each level scales and shifts the parent
					drawers. Use <Typography.Code>actionsRef</Typography.Code> to close all drawers at
					once.
				</Typography.Text>
													...
													<Drawer.Content {...args} style={{ maxWidth: 320 }}>
														...
														<Drawer.Body>
															<Typography.Text
																...
																style={{ marginBottom: "var(--space-4)" }}
															>
																Third level - the deepest drawer. Notice how all parent drawers have
																scaled and shifted.
															</Typography.Text>
...
export const WithPopoverAndHoverCard: Story = {
	...
	render: function Render(args) {
		return (
			...
			>
				<Typography.Text style={{ maxWidth: 500, textAlign: "center" }}>
					Drawers can contain other floating elements like Popovers, Selects, DropdownMenus,
					and HoverCards. Focus management and layering work correctly.
				</Typography.Text>
...
export const WithDialog: Story = {
	...
	render: function Render(args) {
		...
		return (
			...
			>
				<Typography.Text style={{ maxWidth: 500, textAlign: "center" }}>
					Drawers can contain Dialogs for confirmations or additional forms. The Dialog appears
					above the Drawer with proper focus management and layering.
				</Typography.Text>
					...
					<Drawer.Content {...args}>
						...
						<Drawer.Body>
							<Typography.Text
								...
								style={{ marginBottom: "var(--space-4)" }}
							>
								Make changes to your project settings. Click "Delete Project" to see a
								confirmation dialog.
							</Typography.Text>
