...
export const Default: Story = {
	...
	render: () => {
		...
		return (
			<div>
				<Typography.Text render={<p />} style={{ marginBottom: 16 }}>
					...
					{show && (
						<Portal container={containerRef.current}>
							<Card style={{ marginTop: 12 }}>
								<Typography.Text weight="medium">I was rendered here via Portal!</Typography.Text>
								<Typography.Text render={<p />} size="2" color="gray" style={{ marginTop: 8 }}>
									Even though my component is defined on the left, I appear in the custom
									container.
								</Typography.Text>
							</Card>
						</Portal>
		...
		return (
			<div>
				...
				{show && (
					...
					>
						<Typography.Text weight="medium" style={{ color: "inherit" }}>
...
export const ModalExample: Story = {
	...
	render: () => {
		...
		return (
			<div>
				<Typography.Text render={<p />} style={{ marginBottom: 16 }}>
					A simple modal built with Portal. In practice, use the Dialog component for
					accessible modals.
				</Typography.Text>
					...
					<>
						...
						>
							<Card size="3" style={{ width: 400, maxWidth: "90vw" }}>
								<Typography.Heading size="4" style={{ marginBottom: 8 }}>
									Modal Title
								</Typography.Heading>
								<Typography.Text render={<p />} color="gray" style={{ marginBottom: 16 }}>
									This modal is built with two Portal components - one for the backdrop and one for
									the content.
								</Typography.Text>
...
export const ToastNotifications: Story = {
	...
	render: () => {
		...
		return (
			<div>
				<Typography.Text render={<p />} style={{ marginBottom: 16 }}>
					Click the button to show toast notifications. Each toast auto-dismisses after 3
					seconds.
				</Typography.Text>
				...
				<Portal>
					...
					>
						{toasts.map((id, index) => (
							...
							>
								<Typography.Text size="2">Toast notification #{index + 1}</Typography.Text>
							</div>
						))}
					</div>
				</Portal>
