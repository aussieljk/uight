		...
		return (
			...
			>
				<Typography.Text render={<div />} style={{ maxWidth: 500, textAlign: "center" }}>
					Open a dialog from a context menu using controlled state. The dialog is controlled
					...
					<Dialog.Content style={{ maxWidth: 450 }}>
						...
						>
							...
							<label>
								...
								<Textarea
									defaultValue="A sample item description"
...
export const SideAndAlign: Story = {
	...
	render: (args) => (
		...
		>
			<Typography.Text render={<div />} style={{ maxWidth: 500, textAlign: "center" }}>
				Control where the menu appears relative to the click position using{" "}
	...
	render: (args) => (
		...
		>
			<Typography.Text render={<div />} style={{ maxWidth: 500, textAlign: "center" }}>
				...
				(distance from click) and <Typography.Code>alignOffset</Typography.Code> (shift along
				the alignment axis). Right-click each box.
			</Typography.Text>
