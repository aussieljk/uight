...
export const InsetContent: Story = {
	...
	render: (args) => (
		...
		>
			<Typography.Text>
				Use the <Typography.Code>Inset</Typography.Code> component to align content flush with
				the sides of the dialog (bypassing its padding).
			</Typography.Text>
			<div>
				<AlertDialog.Root>
					<AlertDialog.Trigger>
					...
					<AlertDialog.Content style={{ maxWidth: 500 }} {...args}>
						...
						<AlertDialog.Description>
							Are you sure you want to delete these users? This action is permanent and cannot be
							undone.
						</AlertDialog.Description>
...
export const UsingClose: Story = {
	...
	render: (args) => (
		...
		>
			<Typography.Text>
				Base UI provides a single <Typography.Code>Close</Typography.Code> component instead
				of separate <Typography.Code>Action</Typography.Code> and{" "}
				<Typography.Code>Cancel</Typography.Code>. Both close the dialog - use styling to
				differentiate.
			</Typography.Text>
			<AlertDialog.Root>
				<AlertDialog.Trigger>
...
export const DetachedTriggers: Story = {
	...
	render: (args) => (
		...
		>
			<Typography.Text>
				Use <Typography.Code>AlertDialog.createHandle()</Typography.Code> to control a dialog
				from a trigger located outside the <Typography.Code>AlertDialog.Root</Typography.Code>
				.
			</Typography.Text>
		...
		return (
			...
			>
				...
				<div style={{ display: "flex", gap: "var(--space-2)" }}>
					...
					<AlertDialog.Trigger
						handle={handle}
						payload={{ item: "Project A", action: "archive" }}
					>
					...
					<AlertDialog.Trigger
						handle={handle}
						payload={{ item: "Project B", action: "delete" }}
					>
			...
			>
				...
				<AlertDialog.Root actionsRef={actionsRef}>
					...
					<AlertDialog.Content {...args} style={{ maxWidth: 400 }}>
						<AlertDialog.Title>Delete item?</AlertDialog.Title>
						<AlertDialog.Description>
							This will permanently delete the item. The dialog will close automatically when the
							operation completes.
						</AlertDialog.Description>
						<div
							style={{
		...
		return (
			...
			>
				<Typography.Text>
					...
					focus when the dialog opens. For destructive actions, focus the cancel button to
				...
				<div style={{ display: "flex", gap: "var(--space-2)", alignItems: "center" }}>
					<AlertDialog.Root>
						...
						<AlertDialog.Content {...args} style={{ maxWidth: 400 }} finalFocus={inputRef}>
							...
							<AlertDialog.Description>
								This will clear the text you entered. Focus will return to the input field after
								closing.
							</AlertDialog.Description>
							<div
								style={{
