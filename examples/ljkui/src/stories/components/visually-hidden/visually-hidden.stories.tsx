...
export const Default: Story = {
	...
	render: () => (
		<div>
			...
			<Typography.Text render={<p />} color="gray" size="2">
...
export const IconButtonWithLabel: Story = {
	...
	render: () => (
		<div>
			...
			<Typography.Text render={<p />} color="gray" size="2" style={{ marginTop: 12 }}>
...
export const SkipLink: Story = {
	...
	render: () => (
		<div>
			<Typography.Text render={<p />} style={{ marginBottom: 16 }}>
				Skip links help keyboard users bypass navigation. Focus the button below, then press
			...
			<div id="main-content" style={{ padding: 16, border: "1px solid var(--gray-6)" }}>
				<Typography.Text>Main content area</Typography.Text>
			</div>
		</div>
	),
};
