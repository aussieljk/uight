	...
	render: (args: Accordion.RootProps) => (
		<div>
			<p style={{ marginBottom: "var(--space-4)", maxWidth: 600, color: "var(--gray-11)" }}>
				Use your browser's find feature (Ctrl/Cmd + F) to search for "secret keyword" - the
				panel will automatically expand when found.
			</p>
			<Accordion.Root
				style={{
					width: 600,
			...
			>
				<Accordion.Item value="item-1">
					...
					<Accordion.Content>
						This is some visible content in the first section.
					</Accordion.Content>
				</Accordion.Item>
