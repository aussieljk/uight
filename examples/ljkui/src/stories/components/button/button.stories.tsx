...
export const Loading: Story = {
	...
	render: (args) => (
		...
		>
			<Typography.Text>
				Buttons have their own <Typography.Code>loading</Typography.Code> prop that
				automatically composes a spinner.
			</Typography.Text>
			<div style={{ display: "flex", alignItems: "center", gap: "var(--space-4)" }}>
				<Button {...args} variant="classic" />
				<Button {...args} variant="solid" />
			...
			<Typography.Text>
				...
				<Typography.Code>disabled</Typography.Code> state and wrap the icon in a standalone{" "}
				<Typography.Code>{`<Spinner>`}</Typography.Code> to achieve a more sophisticated
				design.
			</Typography.Text>
			<div style={{ display: "flex", alignItems: "center", gap: "var(--space-4)" }}>
...
export const RenderAsDifferentElement: Story = {
	...
	render: (args) => (
		...
		>
			<Typography.Text>
				Use the <Typography.Code>render</Typography.Code> prop to render the button as a
				different element, such as an anchor tag for navigation links or a span for
