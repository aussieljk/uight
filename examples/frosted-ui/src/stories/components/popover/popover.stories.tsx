...
import { Avatar, Button, Checkbox, Code, Heading, IconButton, Inset, Popover, popoverContentPropDefs, SegmentedControl, Separator, Switch, Text, TextArea, TextField } from 'frosted-ui';
...
function QuickActionsDemo({ args }: { args: React.ComponentProps<typeof Popover.Content> }) {
  const actionsRef = React.useRef<{ unmount: () => void; close: () => void } | null>(null);
