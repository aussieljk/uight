 ...
 *
 * It is the frame-realm counterpart to frosted-ui's own
 ...
 * a `<Toaster />` alongside it. uaight declines to read Storybook's global
...
/**
 * Storybook drove frosted-ui's `appearance` from a toolbar global. uaight has
...
function readAppearance(): Appearance {
	...
	const explicit = root.dataset.uaightTheme ?? root.dataset.theme;
...
function subscribeToAppearance(onChange: () => void): () => void {
	...
	observer.observe(document.documentElement, {
		attributes: true,
		attributeFilter: ["class", "data-theme", "data-uaight-theme"],
	});
