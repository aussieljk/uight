	...
	return (
		...
		>
			<input
				...
				aria-label="Search"
				aria-controls="uight-palette-list"
				aria-activedescendant={items[active] ? `uight-palette-${active}` : undefined}
			...
			<div
				ref={listRef}
				id="uight-palette-list"
				role="listbox"
				className="uight-scroll min-h-0 flex-1 py-1"
			>
				{items.length === 0 ? (
