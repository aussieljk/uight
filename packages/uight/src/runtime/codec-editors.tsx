...
function DateCodecEditor(props: CodecEditorProps<string>): React.ReactElement {
	...
	return (
		<div className="uight-codec-editor uight-codec-date">
			<input
				type="datetime-local"
				...
				onChange={onChange}
			/>
			<label className="uight-codec-date-utc">
				<input
					type="checkbox"
					checked={utc}
					disabled={props.disabled}
			...
			<span className="uight-codec-hint" title={props.value}>
				{props.value || "—"}
			</span>
		</div>
	);
...
function RegExpCodecEditor(props: CodecEditorProps<RegExpData>): React.ReactElement {
	return (
		<div className="uight-codec-editor uight-codec-regexp">
			...
			<input
				type="text"
				className="uight-codec-regexp-flags"
...
function UrlCodecEditor(props: CodecEditorProps<string>): React.ReactElement {
	...
	return (
		<input
			className="uight-codec-editor uight-codec-url"
			type="url"
			aria-label={props.label}
			value={draft}
			disabled={props.disabled}
...
function JsonCodecEditor<S>(props: CodecEditorProps<S>): React.ReactElement {
	...
	return (
		<textarea
			className="uight-codec-editor uight-codec-json"
			aria-label={props.label}
...
function FileCodecEditor(props: CodecEditorProps<FileData>): React.ReactElement {
	return (
		<div className="uight-codec-editor uight-codec-file" aria-label={props.label}>
			...
			<span className="uight-codec-hint">
